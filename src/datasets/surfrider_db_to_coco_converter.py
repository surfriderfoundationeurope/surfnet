...
image_filename_to_image_coco_id = {
    ...
    for image_coco_id, image_filename in enumerate(image_filenames)
}

coco_images = [
    {"id": image_coco_id, "file_name": image_filename}
...
for annotation_id, annotation in enumerate(annotations):
    ...
    coco_annotations.append(
        {
            "id": annotation_id,
            "image_id": image_filename_to_image_coco_id[
                image_db_id_to_image_filename[image_db_id]
            ],
            "bbox": [
                annotation["location_x"],
                annotation["location_y"],
                annotation["width"],
                annotation["height"],
            ],
