...
```shell
python  dataset_analysis_train.py --train_path "../ref_images/train.txt" –results_path "./"
```
- Run extract_images_from_video.py :  Get the background images
```shell
python extract_images_from_video.py –num_images 100 --video_dir_path "../background_videos" –save_dir_path "../extracted_background_images/"
```
- Run create_images_num.py: Get the artificial images
```shell
python  create_images_num.py --dataset_path "../data_TACO/data" --background_dataset_path "../extracted_background_images" --result_dataset_path "../artificial_data" –csv_path "../ref_images/labels.csv"
```
...
```
- Drawing a bbox in an image:
```shell
python draw_bbox_taco.py --image_path "../tests/ressources/data/00008.jpg" --annotation_path "../tests/ressources/data/annotations.json"
```
